...
# EVAL_MODE=true → cache bị bypass hoàn toàn, mỗi sample chạy fresh
...
class ProductionRAG:
    ...
    def process_with_context(self, raw_query: str) -> tuple[str, str]:
        ...
        # ── Semantic Cache (skip hoàn toàn trong eval) ──────────────────────────
        if not IS_EVAL_MODE:
        ...
        if analysis.intent == "general":
            ...
            # Fallback: nếu rerank filter hết thì giữ raw_docs top-3
